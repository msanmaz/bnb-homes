...
import { getHouses, getSale } from 'lib/data/getHousePhotos'
...
const Istanbul = ({ houses }) => {
  ...
  return (
    <>
    <Meta title={'Sale | ATTILA HOMES'}/>
      <Hero caption={'For Sale Houses'} main={false} />
      <Intro />
...
export async function getServerSideProps() {
  let houses = await getSale(prisma)
